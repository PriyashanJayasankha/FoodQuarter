 ...
 * @author User
 */
public final class customerSellerProfile extends javax.swing.JFrame {

    /**
     * Creates new form customerSellerProfile
     */
    ...
    public customerSellerProfile() throws ClassNotFoundException, SQLException {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(88, 88, 88)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(foodItemControlButton, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
    ...
    private void updateProfileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateProfileButtonActionPerformed
        UpdateProfileSellerCustomer upsc;
        try {
            upsc = new UpdateProfileSellerCustomer();
            upsc.setVisible(true);
            this.dispose();
        } catch (ClassNotFoundException | SQLException ex) {
            Logger.getLogger(customerSellerProfile.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void foodItemControlButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_foodItemControlButtonActionPerformed
        ...
        FoodItemControl.onlySeller = false;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customerSellerProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try{
                new customerSellerProfile().setVisible(true);
                } 
                catch(ClassNotFoundException ex){
